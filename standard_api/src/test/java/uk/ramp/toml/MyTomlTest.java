...
public class MyTomlTest  {
    ...
    void test() throws IOException {
        ...
        CleanableFileChannel f = new CleanableFileChannel(FileChannel.open(Path.of("D:\\Datastore\\test.toml"), StandardOpenOption.TRUNCATE_EXISTING, StandardOpenOption.WRITE), onClose);
        ...
        p.write(f, "pief", s1);
        if(!f.isOpen()) {
            f = new CleanableFileChannel(FileChannel.open(Path.of("D:\\Datastore\\test.toml"), StandardOpenOption.APPEND), onClose);
