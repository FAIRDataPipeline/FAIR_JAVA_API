...
public interface Config {
  ...
  public interface ConfigItem {
    ...
    /**
     * Config write items may specify the file_type (such as csv, h5, or toml) but this can also be specified using {@link  uk.ramp.api.FileApi#get_dp_for_write(String, String)} method.
