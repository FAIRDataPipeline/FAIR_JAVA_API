...
public class FDPObjectTest {
    ...
    public void testObjectReader1() throws Exception {
        ...
        o = om.readValue("{\"url\":\"https://data.scrc.uk/api/object/73895/?format=json\",\"last_updated\":\"2021-03-31T13:20:51.356604Z\",\"description\":\"test file 2\",\"updated_by\":\"https://data.scrc.uk/api/users/13/?format=json\",\"storage_location\":\"https://data.scrc.uk/api/storage_location/14376/?format=json\",\"file_type\":null,\"issues\":[],\"components\":[],\"data_product\":null,\"code_repo_release\":null,\"external_object\":null,\"quality_control\":null,\"authors\":[],\"licences\":[],\"keywords\":[]}", FDPObject.class);
        Assertions.assertEquals(o.getUrl(), "https://data.scrc.uk/api/object/73895/?format=json");
        Assertions.assertEquals(o.getLast_updated(), LocalDateTime.of(2021, 3, 31, 13, 20, 51, 356604000));
        ...
        Assertions.assertEquals(o.getStorage_location(), "https://data.scrc.uk/api/storage_location/14376/?format=json");
        Assertions.assertNull(o.getFile_type());
        Assertions.assertEquals(o.getIssues(), new ArrayList<String>() {});
        ...
        Assertions.assertNull(o.getExternal_object());
    ...
    public void testObjectReader2() throws Exception {
        ...
        Assertions.assertEquals(o.getStorage_location(), "https://data.scrc.uk/api/storage_location/14350/?format=json");
        Assertions.assertNull(o.getFile_type());
        Assertions.assertEquals(o.getIssues(), new ArrayList<String>() {});
        Assertions.assertEquals(o.getComponents().size(), 15);
        Assertions.assertEquals(o.getData_product(), "https://data.scrc.uk/api/data_product/3341/?format=json");
        Assertions.assertNull(o.getCode_repo_release());
        Assertions.assertNull(o.getExternal_object());
        Assertions.assertNull(o.getQuality_control());
        Assertions.assertEquals(o.getAuthors(), new ArrayList<String>() {});
    ...
    @Test void testObjectToLocalReg() throws Exception {
