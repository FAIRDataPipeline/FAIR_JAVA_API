...
public class Storage_locationWriter implements MessageBodyWriter<Storage_location> {
    Class myClass = Storage_location.class;
    ...
    @Override
    public void writeTo(Storage_location o, Class<?> type,
                        Type genericType,
                        Annotation[] annotations, MediaType mediaType,
