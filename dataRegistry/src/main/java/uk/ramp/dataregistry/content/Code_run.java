...
public class Code_run extends FDP_Updateable{
    ...
    public List<String> getInputs() { return (this.inputs==null) ? new ArrayList<>(){} : new ArrayList<>(this.inputs); }
    public List<String> getOutputs() { return (this.outputs==null) ? new ArrayList<>(){} : new ArrayList<>(this.outputs); }
