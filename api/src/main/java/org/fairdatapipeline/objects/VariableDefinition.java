 ...
 * DimensionalVariableDefinition. It has the full definition of a variable, only lacking
 * 'dimensions' or 'size'. It is used in TableDefinition to define the columns of the table.
 */
