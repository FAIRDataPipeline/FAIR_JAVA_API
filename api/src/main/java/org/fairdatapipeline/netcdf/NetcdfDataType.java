...
public enum NetcdfDataType {
  ...
  public static ucar.ma2.Array translate_array(@NotNull Object o) {
    return ucar.ma2.Array.factory(
        translate(translate_datatype(o)), new int[] {Array.getLength(o)}, o);
  }
   ...
   * @return
   */
  public static ucar.ma2.Array translate_array(
      @NotNull NetcdfDataType dataType, @NotNull int[] dim_sizes, @NotNull Object o) {
